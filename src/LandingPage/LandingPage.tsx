    ...
    return (
        <div>
            ...
            <ul>
                ...
                <li><a href="https://github.com/NateGPTs/kanbas-react-app/tree/a5"> Repository, Branch A5</a></li>
                <li><a href="https://github.com/NateGPTs/kanbas-node-server-app"> Repository, Node Server</a></li>
            </ul>
        </div>
    );
}