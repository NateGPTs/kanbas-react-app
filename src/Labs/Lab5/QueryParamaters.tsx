...
<div id="wd-query-parameters">
  ...
  <a className="btn btn-primary me-2" id="wd-query-parameter-add"
     href={`${REMOTE_SERVER}/Labs/Lab5/calculator?operation=add&a=${a}&b=${b}`}>
    Add {a} + {b}
  </a>
  <a className="btn btn-primary me-2" id="wd-query-parameter-subtract"
     href={`${REMOTE_SERVER}/Labs/Lab5/calculator?operation=subtract&a=${a}&b=${b}`}>
    Substract {a} - {b}
  </a>
  <a className="btn btn-primary me-2" id="wd-query-parameter-subtract"
     href={`${REMOTE_SERVER}/Labs/Lab5/calculator?operation=multiply&a=${a}&b=${b}`}>
    Multiply {a} * {b}
  </a>
  <a className="btn btn-primary me-2" id="wd-query-parameter-subtract"
     href={`${REMOTE_SERVER}/Labs/Lab5/calculator?operation=divide&a=${a}&b=${b}`}>
    Divide {a} / {b}
  </a>
  <hr />
</div>
