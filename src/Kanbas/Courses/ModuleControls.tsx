...
export default function ModulesControls() {
  return (
    <div id="wd-modules-controls" className="d-flex gap-2" >
        <button id="wd-collapse-all" className="btn btn-lg btn-secondary"
          type="button" data-bs-toggle="dropdown"> Collapse all </button>
        <button id="wd-view-progress" className="btn btn-lg btn-secondary"
          type="button" data-bs-toggle="dropdown"> View progress </button>
      ...
      <button id="wd-publish-all-btn" className="btn btn-lg btn-secondary dropdown-toggle"
        ...
        <ul className="dropdown-menu">
          ...
          <li>
            <a id="wd-unpublish-all-and-items" className="dropdown-item" href="#">
